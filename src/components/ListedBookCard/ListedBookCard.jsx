     ...
     <figure className="px-10 pt-10 w-[280px] h-[330px] mt-5">
      ...
      <div className="card-body mt-3">
       ...
       <div className="flex flex-row gap-3 md:items-center md:justify-center">
        ...
        <div>
            <p className="text-[#131313CC] text-lg">Year of Publishing: {yearOfPublishing}</p>
       </div>
       </div>
       </div>
       ...
       <button className="rounded-full text-[#328EFF] font-medium bg-[#328EFF26] px-2 md:px-5 py-3 md:mx-5 my-6">Category: {category}</button>
       <button className="rounded-full text-[#FFAC33] font-medium bg-[#FFAC3326] px-2 md:px-5 py-3 md:mx-5 my-6">Rating: {rating}</button>
       <button onClick={()=>{handleViewBook(bookId)}} className="rounded-full text-white font-medium bg-[#23BE0A] px-2 md:px-5 py-3 md:mx-5 my-6">View Details</button>
       </div>
      </div>
    </div>
  );
